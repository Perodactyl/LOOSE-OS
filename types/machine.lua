...
---@alias componentType "screen" | "gpu" | "computer" | "robot" | "eeprom" | "modem" | "filesystem"
---@alias proxy ScreenProxy | GPUProxy | ComputerProxy | RobotProxy | EEPROMProxy | ModemProxy | FilesystemProxy
...
---@alias DataCardProxy DataCard1Proxy | DataCard2Proxy | DataCard3Proxy
...
---  @field generateKeyPair      fun(bitLen?:number)                                                                                                : PublicKey,PrivateKey                          T3. Generates a public/private key pair for various cryptiographic functions. Optional second parameter specifies key length, 256 or 384 bits accepted. Key types include “ec-public” and “ec-private”. Keys can be serialized with `key.serialize():string` Keys also contain the function `key.isPublic():boolean`.
